...
import 'package:news_app_tempelate_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template news_app_tempelate_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class NewsAppTempelateApiMalformedResponse implements Exception {
  /// {@macro news_app_tempelate_api_malformed_response}
  const NewsAppTempelateApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template news_app_tempelate_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class NewsAppTempelateApiRequestFailure implements Exception {
  /// {@macro news_app_tempelate_api_request_failure}
  const NewsAppTempelateApiRequestFailure({
...
/// {@template news_app_tempelate_api_client}
/// A Dart API client for the news_app_tempelate API.
/// {@endtemplate}
class NewsAppTempelateApiClient {
  /// Create an instance of [NewsAppTempelateApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro news_app_tempelate_api_client}
  ...
  ///
  /// {@macro news_app_tempelate_api_client}
  NewsAppTempelateApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw NewsAppTempelateApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        NewsAppTempelateApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
