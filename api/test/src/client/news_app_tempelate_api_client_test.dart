...
void main() {
  ...
  group('NewsAppTempelateApiClient', () {
    late http.Client httpClient;
    late NewsAppTempelateApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = NewsAppTempelateApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = NewsAppTempelateApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => NewsAppTempelateApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = NewsAppTempelateApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test('makes correct http request (with authorization token).', () async {
        ...
        await NewsAppTempelateApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
      ...
      test(
          'throws NewsAppTempelateApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<NewsAppTempelateApiMalformedResponse>()),
        );
      });

      test(
          'throws NewsAppTempelateApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<NewsAppTempelateApiRequestFailure>()
